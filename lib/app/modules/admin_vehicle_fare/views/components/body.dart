...
import '../../../admin_vehicle_fare/controllers/admin_vehicle_fare_controller.dart';
import 'add_vehicle_fare_dialog.widget.dart';

class AdminVehicleFaresBody extends GetView<AdminVehicleFareController> {
  const AdminVehicleFaresBody({super.key});
              ...
              ElevatedButton(
                onPressed: () {
                  controller.futureDialog.value = Future.wait([
                    ...
                    showDialog(
                      context: context,
                      builder: (ctx) => const AddVehicleFareDialog(),
                    );
                  });
                },
                    ...
                    () => FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.done &&
                          ...
                          return Center(
                            child: Text(
                                'Vehicle fares not available. Please add vehicle fares.'),
                          );
                        } else {
                          return Center(
