...
import 'add_spot_type_dialog.widget.dart';

class AdminSpotTypesBody extends GetView<AdminSpotTypesController> {
  const AdminSpotTypesBody({super.key});
                    ...
                    () => FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.done &&
                          ...
                          return Center(
                            child: Text(
                                'Spot types not available. Please add spot types.'),
                          );
                        } else {
                          return Center(
